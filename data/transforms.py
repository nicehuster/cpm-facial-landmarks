...
class PreCrop(object):
  ...
  def __init__(self, expand_ratio):
    assert expand_ratio is None or isinstance(expand_ratio, numbers.Number), 'The expand_ratio should not be {}'.format(
      expand_ratio)
...
class AugScale(object):
  ...
  def __init__(self, scale_prob, scale_min, scale_max, interpolation=Image.BILINEAR):
    ...
    assert isinstance(scale_min, numbers.Number) and isinstance(scale_max, numbers.Number), 'scales : {:}, {:}'.format(
      scale_min, scale_max)
